...
<body>
            ...
            <div class="h-100">
                ...
                <ul class="sidebar_nav">
                    <li class="sidebar_item active" style="width: 100%;">
                        <a href="?route=dashboard.php" class="sidebar_link"> <img src="assets/img/1. overview.svg" alt="icon">Overview</a>
                    </li>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end position-absolute">
                                ...
                                <a class="dropdown-item" href="auth.php?link='logout'">Log out</a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="Admin_task list-group">
                            ...
                            <div
                                ...
                                <img src="img/warning.svg" alt="icon" add_admin_task  id="finish_offre_update"   >
                            </div>
                            <div
                                class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
    ...
    <div class="modal">
        <div class="modal-content" >
              ...
              <form action="traitement_offre.php" method="POST" enctype="multipart/form-data">
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <div class="mb-4">
                <label class="form-label">image</label>
                <input type="file" class="form-control task-desc" name="file">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select class="form-control" name="status" id="status">
                    <option value="img/default.svg">actif</option>
                    <option value="img/successnew.svg">inactif</option>
                </select>
            </div>

            <div class="d-flex w-100 justify-content-center">
                <button type="submit" class="btn btn-success btn-block mb-4 me-4 ">Save Edit</button>
